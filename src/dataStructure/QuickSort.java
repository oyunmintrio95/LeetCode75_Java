...
/* QuckSort is a sorting algorithm based on the Divide and Conquer algorithm
...
/* Partition Algorithm:
Start from the leftmost element and keep track of the index fo smaller(or equal to) elements as i.
...
public class QuickSort {
    ...
    static int partition(int[] arr, int low, int high){
        ...
        //Index of smaller element and indeicates
    ...
    //The main funciton that implements QuickSort
